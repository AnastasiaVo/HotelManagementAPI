...
namespace FavorParkHotelAPI.Application.Authentification.Services
{
    ...
    //    public CreateUserService(UserManager<UserEntity> userManager, RoleManager<RoleEntity> roleManager, IConfiguration configuration)
    //    {
    ...
    //    public async Task<Response<GetUserDto>> CreateUserAsync(RegisterUserDto userApplyModel)
    //    {
    //        var jwtOptions = new ConnectionStringOptions(_configuration);

    //        var user = new UserEntity()
    //        {
    //            Email = userApplyModel.Email,
    //            UserName = userApplyModel.FirstName + userApplyModel.LastName,
    //            PhoneNumber = userApplyModel.PhoneNumber,
    //            FirstName = userApplyModel.FirstName,
    //            LastName = userApplyModel.LastName
    //        };

    //        var roles = new List<string> { DefaultUserRole, AdminRole };

    //        var identityResult = await _userManager.CreateAsync(user, userApplyModel.Password);
